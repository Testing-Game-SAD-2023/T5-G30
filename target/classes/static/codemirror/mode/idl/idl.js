...
(function(mod) {
  ...
  var builtinArray = [
    ...
    'alog30', 'alog10', 'amoeba', 'annotate', 'app_user_dir',
    ...
    'get_lun', 'get_screen_size', 'getenv', 'getwindows', 'greg30jul',
    ...
    'json_serialize', 'jul2greg', 'julday', 'keyword_set', 'krig30d',
    ...
    'query_jpeg30000', 'query_mrsid', 'query_pict', 'query_png', 'query_ppm',
    ...
    'read_interfile', 'read_jpeg', 'read_jpeg30000', 'read_mrsid', 'read_pict',
    ...
    'write_jpeg', 'write_jpeg30000', 'write_nrif', 'write_pict', 'write_png',
